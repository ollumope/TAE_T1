...
ECV_VIVIENDA_BARRIO_SCALE <- tibble::column_to_rownames(ECV_VIVIENDA_BARRIO, var = "barrio")
...
```
De acuerdo a la gráfica donde se da el cambio de pendiente más significativo es en el k = 8
...
#[,2:9]
set.seed(1988)
kmeans_model <- kmeans(ECV_VIVIENDA_BARRIO_SCALE, 8, nstart = 50)
kmeans_model
```
