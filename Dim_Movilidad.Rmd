...
Algunos barrios de este grupo:

```{r}
head(df_member2[df_member2$cluster == 1,]$barrio_2)
```
...
```{r}
head(df_member2[df_member2$cluster == 2,]$barrio_2)
```
...
```{r}
head(df_member2[df_member2$cluster == 3,]$barrio_2)
```
...
```{r}
head(df_member2[df_member2$cluster == 4,]$barrio_2)
```
...
```{r}
head(df_member2[df_member2$cluster == 5,]$barrio_2)
```
...
```{r}
head(df_member2[df_member2$cluster == 6,]$barrio_2)
```
...
```{r}
head(df_member2[df_member2$cluster == 7,]$barrio_2)
```
