...
Con el fin de medir la permanencia de los hogares en un barrio, se determina que 6 a&ntilde;os es un tiempo prudente para indicar que las personas se siente c&oacute; en el barrio y por tal motivo permanecen en &eacute;l
...
Para medir que tan conectados a la f&aacute;cil para los hogares de la ciudad de Medell&iacute; conseguir el agua para el consumo humano, se seleccionan para la medici&ocute; las opciones 1 y 2
...
Caracter&iacute;sticas que distinguen un grupo de barrios de otro
 ...
 - Grupo 2: se caracterizan por contar con menos personas por hogar, tener m&aacute;s apartamentos que casas, muchas de ellos propias, un 97% de la poblaci&oacute;n cuentan con los servicios p&uacute;blicos b&aacute y es el grupo que mayor acceso a internet tiene
 
 - Grupo 3: se caracterizan por vivir mayoremente en casas propias y tener bajo acceso a internet y a los servicios p&uacute;blicos b&aacute, varios de los que tienen el acceso lo tienen suspendidos.
